...
const questions = [
  "ช่วยเล่าเกี่ยวกับตัวคุณ และอะไรเป็นเหตุผลที่ทำให้คุณเลือกเรียนสาขานี้และมหาวิทยาลัยนี้?",
  "อะไรคือความแตกต่างที่ชัดเจนที่สุดระหว่างสิ่งที่คุณคาดหวังจากมหาวิทยาลัยกับสิ่งที่คุณกำลังเผชิญอยู่จริง?",
  "ลองนึกถึงช่วงเวลาที่มีความหมายที่สุดในมหาวิทยาลัยของคุณ แล้วช่วยเล่าว่าเกิดอะไรขึ้น และมันส่งผลต่อเป้าหมายในชีวิตของคุณอย่างไร?",
  "เมื่อพิจารณาเวลาและทรัพยากรที่คุณลงทุนไปกับการศึกษา คุณคิดว่ามีส่วนใดที่คุ้มค่าที่สุด และส่วนใดที่คุณมองว่าสูญเปล่า?",
];

export default function StudyingForm() {
    ...
    switch (stage) {
        ...
        return (
          ...
          >
            ...
            <p className="text-lg text-gray-600 mb-8 leading-relaxed max-w-2xl mx-auto font-thai">
              ...
              คำตอบของคุณจะช่วยให้เราเข้าใจผลกระทบระยะยาวของการศึกษาระดับอุดมศึกษาต่อชีวิตของนักศึกษา
            </p>
      ...
      case "form":
        return (
          ...
          >
            <h2 className="text-xl font-semibold mb-4 text-blue-800 font-thai">
      ...
      case "thanks":
        return (
          ...
          >
            <h2 className="text-2xl font-semibold mb-4 text-blue-800 font-thai">
              ขอบคุณสำหรับการมีส่วนร่วม!
            </h2>
            <p className="text-lg text-gray-600 mb-6 font-thai">
              คำตอบของคุณมีค่าอย่างยิ่งต่อการวิจัยของเรา
              และจะช่วยให้เราเข้าใจผลกระทบของการศึกษาระดับอุดมศึกษาต่อชีวิตของนักศึกษาได้ดียิ่งขึ้น
            </p>
            <p className="text-lg text-gray-600 mb-6 font-thai">
